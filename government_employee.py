...
for x in range(row_count-1):
    ...
    newdata2.append(doc.tables[2].cell(2,2).paragraphs[0])
    newdata2.append(doc.tables[2].cell(2,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(3,2).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(3,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(4,2).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(4,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(5,2).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(5,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(6,2).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(6,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(7,2).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(7,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(8,2).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(8,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(9,2).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(9,3).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(2,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(2,5).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(3,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(3,5).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(4,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(4,5).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(5,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(5,5).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(6,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(6,5).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(7,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(7,5).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(8,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(8,5).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(9,4).paragraphs[0]) 
    newdata2.append(doc.tables[2].cell(9,5).paragraphs[0])
    ...
    doc.save(str(x+1)+'_'+name+'_'+sname+'_'+own+'.docx')
    print("========End========")
